...

            {
                data?.length > 0 ? <div className="overflow-x-auto">
                    ...
                    <table className="table table-xs mt-10">
                        ...
                        <tbody>
                            {
                                renderBookings?.map(booking => <tr className="my-5 text-center" key={booking._id}>
                                    ...
                                    <td><button className=" btn text-orange-600 bg-transparent ">{<GiStarsStack className="text-xl " />}</button></td>
                                    <td><button className=" btn text-blue-600 bg-transparent ">{<AiTwotoneDollar className="text-xl " />}</button></td>
