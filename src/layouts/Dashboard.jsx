...
const Dashboard = () => {
    ...
    const navlinks = <>
        {
            user && userType === "user" && <>
                <NavLink to="/dashboard/userProfile" className="text-white font-medium uppercase  mb-5 p-4 flex items-center gap-2"> <FaUserLarge className="text-2xl" /> My Profile</NavLink>
...

        {
            user && userType === "deliveryMan" && <>
                ...
                <NavLink to="/dashboard/myReviews" className="text-white font-medium flex items-center gap-2  uppercase mb-5 p-4"><GiStarsStack className="text-2xl" /> My reviews</NavLink>
            </>
        }

        {
            user && userType === "admin" && <>
                <NavLink to="/dashboard/statistics" className="text-white font-medium uppercase  mb-5 p-4 flex items-center gap-2"> <IoMdStats className="text-2xl" />Statistics</NavLink>
