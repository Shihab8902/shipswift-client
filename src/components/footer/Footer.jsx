        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content border-b-2 ">
                <aside>
                    ...
                    <p>ShipSwift cargo industry limited.<br />Providing reliable shipping services since 2008</p>
                </aside>
                <nav>
            ...
            <footer className="footer p-10 bg-base-200 text-base-content border-b-2">
                <nav>
                    ...
                    <Link className="link link-hover">Warehouse Moving</Link>
                </nav>
                <nav>
                ...
                <nav>
                    <header className="footer-title">Industries</header>
                    <Link className="link link-hover">Chemicals</Link>
                    <Link className="link link-hover">Automotive</Link>
                    <Link className="link link-hover">Consumer Goods</Link>
                    <Link className="link link-hover">Life Science</Link>
                    <Link className="link link-hover">Foreign Trade</Link>
                </nav>
                <form>
                    ...
                    <fieldset className="form-control max-w-80">
                        ...
                        <div className="join">
                            <input type="text" placeholder="user@example.com" className="input input-bordered w-full join-item" />
            ...
            <footer className="footer footer-center p-4 bg-base-200 text-base-content">
                <aside>
                    <p>Copyright © 2023 - All right reserved by ShipSwift Industries Ltd</p>
                </aside>
            </footer>
        </div>
    )
